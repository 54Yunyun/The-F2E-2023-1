...
<template>
  ...
  <!-- slogan -->
  <div class="flex flex-col mt-52 justify-center items-center gap-6">
    <div
      class="title-gradient font-ManTouSans flex justify-center text-center flex-col text-6xl xl:flex-row xl:text-7xl gap-4"
    >
      <span>台灣的明天</span>
      <span>喵先鋪路</span>
    </div>
